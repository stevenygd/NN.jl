...
l4_3 = Addition([l3_3, l2_3])
l5_3 = Addition([l4_3, l3_3])
graph3 = Graph(l5_3)
...
l4 = Flatten(l3)
l5 = DenseLayer(l4, 10)
l1_2 = CaffeConv(l0, 32, (5,5))
l2_2 = ReLu(l1_2)
l3_2 = MaxPool(l2_2, (2, 2))
l4_2 = Flatten(l3_2)
