...
function build_model(batch_size)
    ...
    l1    = BlockFixedFC{Int16}(layerX, 1000)
    l2    = BlockFixedFC{Int16}(l1, 1000)
    l3    = BlockFixedFC{Int16}(l2, 1000)
    l4    = SoftMaxCrossEntropyLoss(l3, layerY)
    return l1, l2, l3, layerX, layerY, Graph(l4)
end
